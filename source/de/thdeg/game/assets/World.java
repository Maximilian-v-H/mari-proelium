...
public class World {
    ...
    public short[] parseImage(String what) {
        ...
        try {
            myReader = new Scanner(new File("source" + File.separator + "de" + File.separator + "thdeg" + File.separator + "game" + File.separator + "assets" + File.separator + "img" + File.separator + what));
